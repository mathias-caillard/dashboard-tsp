...
#Chemin absolu du repertoire de travail (chemin vers
root_directory = os.path.abspath(os.path.dirname(__file__))

rep_parent = os.path.dirname(root_directory)    #(projet cassiopee)
...
#Recupération des annees des historiques
...
#Annees pour la selection de l'annee (le menu deroulant)
...
#Annees pour la mise à jour des donnees
...
# Definir une palette de couleurs pour chaque trimestre

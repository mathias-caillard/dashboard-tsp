...
import effectifs
import data.data
from src.data.data import data_moy
...
line = data.data.df_ligne[0]
titre = data.data.extract_titre(data.data.df_ligne)
annees = data.data.annees
data_old_1 = data.data.extract_data(sheetName, line)
data_old = [data_old_1]
